...
class SoilConstraints(object):
    ...
    def calculateSoilQualities(self, irr_or_rain, topsoil_path='A:/shradhha/py_aez/PyAEZ-master/sample_data/input/soil_characteristics_topsoil.csv', subsoil_path='A:/shradhha/py_aez/PyAEZ-master/sample_data/input/soil_characteristics_subsoil.csv'):
        if irr_or_rain == 'I':
